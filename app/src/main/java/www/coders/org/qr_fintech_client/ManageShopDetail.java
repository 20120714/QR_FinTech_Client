...
public class ManageShopDetail extends AppCompatActivity {
    ...
    private static final String PATH_READ = Server.URL + "/shop_detail";
    private static final String PATH_APPLY = Server.URL + "/shop_insert";
    private static final String PATH_DELETE = Server.URL + "/shop_delete";
